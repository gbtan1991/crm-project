...
export function BookingsCalendarToolbar({
  businessId,
  initialStatus,
}: {
  businessId: string;
  ...
  const bookingsPath = businessBookingsPath(businessId);
  ...
  async function handleReconnect() {
    ...
    try {
      const res = await fetch(endpoint, {
        ...
        body: JSON.stringify({ businessId, redirectPath: bookingsPath }),
      });
